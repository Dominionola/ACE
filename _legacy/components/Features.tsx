  ...
  return (
    <section className="py-24 md:py-32 px-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(300px,auto)]">
        ...
        <div className="animate-fade-in-up delay-100 group relative md:col-span-2 rounded-3xl overflow-hidden bg-white border border-ace-blue/10 shadow-sm hover:shadow-xl hover:scale-[1.01] transition-all duration-500">
        ...
        <div className="animate-fade-in-up delay-200 group relative rounded-3xl overflow-hidden bg-ace-blue text-cream-50 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500">
        ...
        <div className="animate-fade-in-up delay-300 group relative rounded-3xl overflow-hidden bg-white border border-ace-blue/10 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500">
        ...
        <div className="animate-fade-in-up delay-400 group relative rounded-3xl overflow-hidden bg-cream-100 border border-ace-blue/5 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500">
           <div className="p-8">
              <div className="flex items-center gap-3 mb-4">
        ...
        <div className="animate-fade-in-up delay-500 group relative md:col-span-2 md:col-start-2 lg:col-span-1 lg:col-start-3 rounded-3xl overflow-hidden bg-white border border-ace-blue/10 shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all duration-500 min-h-[300px]">
           <img 
