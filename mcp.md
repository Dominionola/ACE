...
To start the interactive chatbot and interact with your workflow:

```python
from concierge import Concierge

# Initialize the agent with your workflow
agent = Concierge(workflow=AmazonShoppingWorkflow)

# Open the interactive chatbot interface
agent.open_chatbot()
```

## License

Concierge is released under the MIT License.
